...
export function Task({ id, descriptionTask, checkedTask, onDeleteTask, onCompleteTask }: TaskProps) {
      ...
      <div className={styles.task}>
        <div className={styles.content}>
          ...
          <div className={styles.descriptionTask}>
            <p className={checkedTask === true ? styles.checked : undefined}>{descriptionTask}</p>
          </div>
          <button 
